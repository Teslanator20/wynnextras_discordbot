...
LOOTRUN_EMOJIS = {
    "SE": f'<:{LOOTRUN_EMOJI_NAME}:{LOOTRUN_EMOJI_ID}>',
    "SI": f'<:{LOOTRUN_EMOJI_NAME}:{LOOTRUN_EMOJI_ID}>',
    "MH": f'<:{LOOTRUN_EMOJI_NAME}:{LOOTRUN_EMOJI_ID}>',
    "CORK": f'<:{LOOTRUN_EMOJI_NAME}:{LOOTRUN_EMOJI_ID}>',
    "COTL": f'<:{LOOTRUN_EMOJI_NAME}:{LOOTRUN_EMOJI_ID}>',
    "WFF": f'<:{LOOTRUN_EMOJI_NAME}:{LOOTRUN_EMOJI_ID}>',
    "EFF": f'<:{LOOTRUN_EMOJI_NAME}:{LOOTRUN_EMOJI_ID}>'
}
